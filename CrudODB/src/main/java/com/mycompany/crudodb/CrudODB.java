...
public class CrudODB {
    ...
    private static EntityManagerFactory emfPedidos;
    private static EntityManagerFactory emfCarta;

    static {
        emfPedidos = Persistence.createEntityManagerFactory("emfpedidos.odb");
        emfCarta = Persistence.createEntityManagerFactory("emfcarta.odb");
    }

    public void saveCarta(Carta c){
        EntityManager em = emfCarta.createEntityManager();
    ...
    public void crearPedido() {
        ...
        EntityManager em = emfPedidos.createEntityManager();
        em.getTransaction().begin();
        em.persist(p);
        em.getTransaction().commit();
        em.close();
